...
-- ----------------------------
-- Table structure for pms_product_copy
-- ----------------------------
DROP TABLE IF EXISTS `pms_product_copy`;
CREATE TABLE `pms_product_copy` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `shop_id` bigint(20) NOT NULL COMMENT '店铺ID',
  `brand_id` bigint(20) DEFAULT NULL COMMENT '品牌ID',
  `product_category_id` bigint(20) DEFAULT NULL COMMENT '产品类别ID',
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=294 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('282', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-04 08:38:10');
INSERT INTO `sys_logininfor` VALUES ('283', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-04 08:49:15');
INSERT INTO `sys_logininfor` VALUES ('284', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-04 08:55:11');
INSERT INTO `sys_logininfor` VALUES ('285', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '1', '验证码错误', '2019-12-04 09:01:11');
INSERT INTO `sys_logininfor` VALUES ('286', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-04 09:01:18');
INSERT INTO `sys_logininfor` VALUES ('287', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-04 09:03:20');
INSERT INTO `sys_logininfor` VALUES ('288', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-27 14:53:44');
INSERT INTO `sys_logininfor` VALUES ('289', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-27 15:21:08');
INSERT INTO `sys_logininfor` VALUES ('290', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-27 15:47:25');
INSERT INTO `sys_logininfor` VALUES ('291', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-27 15:54:10');
INSERT INTO `sys_logininfor` VALUES ('292', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2019-12-27 15:58:49');
INSERT INTO `sys_logininfor` VALUES ('293', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-01-08 15:56:57');
...
CREATE TABLE `sys_menu` (
  ...
  `remark` varchar(500) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2055 DEFAULT CHARSET=utf8 COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('2039', '商品', '3', '1', '/system/product', 'C', '0', 'system:product:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
INSERT INTO `sys_menu` VALUES ('2040', '商品查询', '2039', '1', '#', 'F', '0', 'system:product:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2041', '商品新增', '2039', '2', '#', 'F', '0', 'system:product:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2042', '商品修改', '2039', '3', '#', 'F', '0', 'system:product:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2043', '商品删除', '2039', '4', '#', 'F', '0', 'system:product:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2044', '商品信息', '0', '0', '#', 'M', '0', '', 'fa fa-life-saver', 'admin', '2019-12-27 15:56:34', '', null, '');
INSERT INTO `sys_menu` VALUES ('2045', '商品', '3', '1', '/system/product', 'C', '0', 'system:product:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
INSERT INTO `sys_menu` VALUES ('2046', '商品查询', '2044', '1', '#', 'F', '0', 'system:product:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2047', '商品新增', '2044', '2', '#', 'F', '0', 'system:product:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2048', '商品修改', '2044', '3', '#', 'F', '0', 'system:product:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2049', '商品删除', '2044', '4', '#', 'F', '0', 'system:product:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2050', '商品', '2044', '1', '/system/product', 'C', '0', 'system:product:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
INSERT INTO `sys_menu` VALUES ('2051', '商品查询', '2044', '1', '#', 'F', '0', 'system:product:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2052', '商品新增', '2044', '2', '#', 'F', '0', 'system:product:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2053', '商品修改', '2044', '3', '#', 'F', '0', 'system:product:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2054', '商品删除', '2044', '4', '#', 'F', '0', 'system:product:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
...
INSERT INTO `sys_oper_log` VALUES ('194', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/pms_product', '127.0.0.1', '内网IP', '{}', '0', null, '2019-12-04 08:43:17');
INSERT INTO `sys_oper_log` VALUES ('195', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/pms_product', '127.0.0.1', '内网IP', '{}', '0', null, '2019-12-04 08:49:28');
INSERT INTO `sys_oper_log` VALUES ('196', '菜单管理', '1', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.addSave()', '1', 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"商品信息\"],\"url\":[\"\"],\"perms\":[\"\"],\"orderNum\":[\"4\"],\"icon\":[\"fa fa-navicon\"],\"visible\":[\"0\"]}', '0', null, '2019-12-04 09:10:29');
INSERT INTO `sys_oper_log` VALUES ('197', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/pms_product', '127.0.0.1', '内网IP', '{}', '0', null, '2019-12-27 15:42:19');
INSERT INTO `sys_oper_log` VALUES ('198', '菜单管理', '1', 'com.aaa.repast.admin.project.system.menu.controller.MenuController.addSave()', '1', 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"商品信息\"],\"url\":[\"\"],\"perms\":[\"\"],\"orderNum\":[\"0\"],\"icon\":[\"fa fa-life-saver\"],\"visible\":[\"0\"]}', '0', null, '2019-12-27 15:56:34');
INSERT INTO `sys_oper_log` VALUES ('199', '代码生成', '8', 'com.aaa.repast.admin.project.tool.gen.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/ums_member', '127.0.0.1', '内网IP', '{}', '0', null, '2020-01-08 16:00:48');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', 'Seven', '00', '396691973@qq.com', '15903658019', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-01-08 15:56:57', 'admin', '2019-11-19 11:33:00', 'ry', '2020-01-08 15:56:57', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('dcba8b94-7d8a-42cf-98ec-3176fc986fcd', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2020-01-08 15:56:51', '2020-01-08 16:00:48', '1800000');
...
-- ----------------------------
INSERT INTO `ums_member` VALUES ('2', null, null, null, null, '123', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '312fdfsd3214312433213', null, '8efd0dc788c945309b9762cab7def4ac312fdfsd3214312433213');
INSERT INTO `ums_member` VALUES ('3', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, '32132143112311', null, 'bc15128f34d346b5bd4037c47b4d074532132143112311');
INSERT INTO `ums_member` VALUES ('4', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'wqeq312', null, 'c3bd773a996f452296885a9b76820504wqeq312');
INSERT INTO `ums_member` VALUES ('5', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 'dasdeqw3213213', null, '8c02e3096800489baa56e812e42ca13bdasdeqw3213213');
...
CREATE TABLE `ums_member_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='会员登录记录';

-- ----------------------------
-- Records of ums_member_login_log
-- ----------------------------
INSERT INTO `ums_member_login_log` VALUES ('1', null, null, '2020-01-02 03:11:29', '127.0.0.1', '用户登录', '1', '登录操作');
...
CREATE TABLE `ums_shop_facility` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='店铺的基础设置，例如：Wi-Fi，纸巾，停车位，包厢等';
